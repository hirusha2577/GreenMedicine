package com.clay.product_service.service;

import com.clay.product_service.model.Authorized;
import com.clay.product_service.model.Product;
import com.clay.product_service.repository.ProductRepository;
...
public class ProductService {
    ...
    public Boolean isSeller(String authorization) {
        ...
        ResponseEntity<Authorized> response = restTemplate.exchange(
                "http://localhost:5002/api/auth/authorizeSeller", HttpMethod.GET, entity,
